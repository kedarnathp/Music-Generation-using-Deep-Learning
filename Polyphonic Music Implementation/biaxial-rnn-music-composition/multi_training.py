...
def trainPiece(model,pieces,epochs,start=0):
    ...
    for i in range(start,start+epochs):
        ...
        if i % 500 == 0 or (i % 100 == 0 and i < 1000):
            ...
            noteStateMatrixToMidi(numpy.concatenate((numpy.expand_dims(xOpt[0], 0), model.predict_fun(batch_len, 1, xIpt[0])), axis=0),'output_piano_200/sample{}'.format(i))
            pickle.dump(model.learned_config,open('output_piano_200/params{}.p'.format(i), 'wb'))
