...
def train(text, epochs=100, save_freq=10):
    ...
    print("Number of unique characters: " + str(len(char_to_idx))) #63
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', default='polyphonic_piano_music.txt', help='name of the text file to train from')
